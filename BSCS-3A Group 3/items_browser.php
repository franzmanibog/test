...
<head>
    ...
    <title>Casan's Items Browser</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div>
        <img src="https://i.imgur.com/athXVqN.png" alt="Casan's Footwear Logo" width="400">
    </div>
    <form action="" method="post">
                ...
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/Trg22Zo.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Pink Slides ₱100</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_pink_slides" name="quantity_pink_slides" style="width: 30px;">
                                ...
                                ?>
                                <input name="pink_slides" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/plvmCa7.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Blue Slippers ₱150</h2>
                                <div class="flex_container_row">
                                <input type='text' id="quantity_blue_slippers" name="quantity_blue_slippers" style="width: 30px;">
                                ...
                                ?>
                                <input name="blue_slippers" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/EPTDHsQ.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Red Shirt ₱150</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_red_shirt" name="quantity_red_shirt" style="width: 30px;">
                                ...
                                ?>
                                <input name="red_shirt" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/epvIVGF.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Black Sandals ₱150</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_Black_sandals" name="quantity_Black_sandals" style="width: 30px;">
                                ...
                                ?>
                                <input name="Black_sandals" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/57E3TsJ.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Pink Slippers ₱100</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_pink_slippers" name="quantity_pink_slippers" style="width: 30px;">
                                ...
                                ?>
                                <input name="pink_slippers" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/rR0OD7G.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Black Shirt ₱150</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_black_shirt" name="quantity_black_shirt" style="width: 30px;">
                                ...
                                ?>
                                <input name="black_shirt" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/oJHTHAf.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>Bnw Sneakers ₱200</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_bnw_sneakers" name="quantity_bnw_sneakers" style="width: 30px;">
                                ...
                                ?>
                                <input name="bnw_sneakers" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/DwRpVwl.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                        <h2>Pretty Slippers ₱120</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_pretty_slippers" name="quantity_pretty_slippers" style="width: 30px;">
                                ...
                                ?>
                                <input name="pretty_slippers" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="browser_window">
                    <div class="flex_container_row">
                        <div class="flex_container_column">
                            ...
                            <img src="https://i.imgur.com/XGMI6Qk.jpg" id="preview"></img>
                        </div>
                        <div class="flex_container_column">
                            <h2>USB Charger ₱100</h2>
                            <div class="flex_container_row">
                                <input type='text' id="quantity_usb_charger" name="quantity_usb_charger" style="width: 30px;">
                                ...
                                ?>
                                <input name="usb_charger" type="submit" value="ADD TO CART" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="cart_logo">
            <img src="https://i.imgur.com/wOUQbAr.png" alt="image" width="130px" onclick="location.href='cart.php'">
            <br>
