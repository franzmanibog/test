...
<body>
    <div>
        <form action="" method="post">
            ...
            <div class="flex_container_row">
                <div class="flex_container_column">
                    <div class="subform" style="padding-top: 235px;">
                        ...
                        <select id="nationality" name="nationality" style="width: 165px;">
        ...
        <div style="margin-top:-445px; margin-left: 15px;">
            <h2>New Employee</h2>
            <form>
                <img id="pic_box" width="140px" height="140px">
                <br>
            ...
            <form action="" method="post">
                <div class="flex_container_column" style="width:401px; margin-top: 152px; margin-left: 406px;">
