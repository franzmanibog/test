        ...
        <form action="" method="post" >
            <div class="flex_container_row">
                <div>
                    ...
                    <div class="title">
                        <img src="https://i.imgur.com/fyGfZJ0.png" alt="Casan's Footwear Logo" width="400">
                    </div>
                    <div class="subform">
                        ...
                        <input type="text" name="product_name" value="<?php echo ($product_name);?>"readonly><br>

                        <!-- if they click a button of a product, the product price will be display here-->
                        <label for="price">Price:</label>
                        <input type="text" name="price" value="<?php echo ($price);?>"readonly><br>
                        ...
                        <input type="text" name="discount_amount" value="<?php echo($discount_amount);?>"readonly><br>
                        ...
                        <input type="text" name="discounted_amount" value="<?php echo($discounted_amount);?>"readonly><br>
                    ...
                    <div class="subform">
                        ...
                        <input type="text" name="total_bills" value="<?php echo($total_bills);?>"readonly><br>

                        <!-- all total confirmed quantity will be plac here-->
                        <label for="total_quantity">Total Quantity:</label>
                        <input type="text" name="total_quantity" value="<?php echo($total_quantity);?>"readonly><br>
                        ...
                        <input type="text" name="change" value="<?php echo($change);?>"readonly><br>
                ...
                <div class="flex_container_column" style="margin-left:40px">
                    ...
                    <div class="flex_container_row" id="ordering_app_buttons">
                        ...
                        <!-- button for back and will b redirected to landing page-->
