...
<body>
    <div class="flex_container_row">
        <div class="flex_container_column" style="padding-left: 3px">
            <div>
                <img src="https://i.imgur.com/pk3nvlF.png" alt="Casan's Footwear Logo" width="400px">
            </div>
            <div class="subform" style="height: 420px">
                <form>
                    <img id="preview" width="140px" height="140px">
                    <br>
        ...
        <form action="" method="post">
            <div class="flex_container_row">
                <div class="flex_container_column">
                    <div style="margin-top: 330px; margin-left: -410px;">
        ...
        <form action="" method="post">
            <div class="flex_container_row" style="margin-top: 527px; margin-left: -345px;">
                <input name="employee_list" type="submit" value="EMPLOYEE LIST">
                <input name="logout" type="submit" value="LOGOUT" style="margin-left: 4px">
            </div>
        </form>
    </div>
</body>
