...
<body>
    <div>
        <div>
            <img src="https://i.imgur.com/83cIUZH.png" alt="Casan's Logo" width="400">
        </div>
        <form method="post" action="">
            <div class="flex_container_row">
                <div class="subform" style="min-width: 800px;">
                    <table width="800">
                        <tr>
                            <th>Product Name</th>
                            <th>Quantity</th>
                ...
                <div class="flex_container_column">
                    <div class="subform">
                        ...
                        <input name="confirm_shipping_address" type="submit" value="CONFIRM SHIPING ADDRESS">
