    ...
    <div class="container">
        <div class="page_border">
            <form id="pic-upload" class="a-form" enctype="multipart/form-data" method="post" width='840'>
                <h4 style="margin-bottom:20px;">New Employee</h4>
                <h5 class="mb-0 font-weight-bold">Personal Info</h5>
                <div class="a-form-group mt-3" style="float:left; clear:block; width:20%;">
                    <div id="pic-box" style='width:170px; height:150px; overflow:hidden; margin-
 top:7px; margin-left:5px; background:none; border:thin solid #d3d3d3'></div>
                    <input type="file" style="margin top:10px; text:center;" id="uploadfile" name="uploadfile"
                        value="" />
                </div>
            </form>
            <form id="employee_registration_save" class="a-form" action="employee_registration_save.php" method="post"
                width='840'>
                <div class="a-form-group mt-3">
                    ...
                    <div class="a-fields-group mt-0">
                        <div class="form-row">
                            ...
                            <div class="form-group col-3">
                                <label for="qualified_dependent_status" class="mb-0 control-label">Qualified Dep. Status
                                </label>
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control mt-0" name="employee_status" id="employee_status"
                                    value="">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-4">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control mt-0" name="employee_number"
                                        id="employee_number" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="a-fields-group mt-0">
                            <div class="form-row">
                                <div class="form-group col-5">
                                    ...
                                    <input type="text" class="form-control mt-0" name="contact_number"
                                        id="contact_number" value="">
                                </div>
                                <div class="form-group col">
                                    <label for="email" class="mb-0 control-label">Email</label>
                                    <input type="text" class="form-control mt-0" name="email_address" id="email_address"
                                        value="">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    <label for="social_media_account_id" class="mb-0 control-label">Social Media Account
                                        ID/No.</label>
                                    <input type="text" class="form-control mt-0" name="social_media_account_id"
                        ...
                        <div class="a-fields-group">
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control mt-0" name="address_line1"
                                        id="address_line1">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-10">
                                    ...
                                    <input type="text" class="form-control mt-0" name="address_line2"
                                        id="address_line2">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control mt-0" name="state_province"
                                        id="state_province">
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-group col3">
                                ...
                                <input type="text" class="form-control mt-0" name="picpath" id="picpath"
                                    value="<?php echo "$target" ?>">
                            </div>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary" name="savebtn" style="width:130px;">Save</button>
                <button type="reset" class="btn btn-outline-secondary" name="cancelbtn"
